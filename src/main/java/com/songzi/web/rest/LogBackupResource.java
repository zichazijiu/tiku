...
public class LogBackupResource {
    ...
    @Timed
    public ResponseEntity<List<LogBackup>> getAllLogBackups(Pageable pageable) {
        log.debug("REST request to get a page of LogBackups");
        Page<LogBackup> page = logBackupRepository.findAll(pageable);
