            ...
            if (id) {
                this.checkItemService.find(id)
                    .subscribe((checkItemResponse: HttpResponse<CheckItem>) => {
                        ...
                        if (checkItem.createdDate) {
                            checkItem.createdDate = {
                                year: checkItem.createdDate.getFullYear(),
                                month: checkItem.createdDate.getMonth() + 1,
                                day: checkItem.createdDate.getDate()
                            };
                        }
